...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const dom = {
        ...
        chatOrderBtn:        document.getElementById(config.selectors.chatOrderBtn.substring(1)),
        body:                document.body,
    };

    if (!dom.cartItemsContainer || !dom.cartTotalPriceEl || !dom.cartEmptyMsg ||
        !dom.clearCartBtn || !dom.chatOrderBtn || !dom.cartModalElement) {
