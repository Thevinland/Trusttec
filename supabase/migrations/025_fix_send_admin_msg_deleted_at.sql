-- Fix: send_admin_msg — AND deleted_at IS NOT NULL pour éviter les écritures inutiles
...
BEGIN
  ...
  -- Restaurer UNIQUEMENT les lignes qui ont un deleted_at (évite les écritures inutiles)
